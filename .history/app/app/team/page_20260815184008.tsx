            ...
            <tbody className="divide-y divide-slate-800/60">
              {members.map((m, idx) => (
                <tr key={idx} className="hover:bg-slate-800/20 transition-colors group">
                  ...
                  <td className="p-4">
                    <span className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-md bg-emerald-500/10 text-emerald-400 border border-emerald-500/30 text-[9px] font-mono font-medium tracking-wide">
