  ...
  return (
    <div className="space-y-6">
      <div className="pb-4 border-b border-slate-800/80 flex items-end justify-between gap-4">
        <div>
          <div className="inline-flex items-center gap-1.5 px-2.5 py-0.5 rounded-md bg-amber-500/10 text-amber-400 border border-amber-500/20 font-mono text-[10px] uppercase tracking-wider mb-2">
            CLIENT PROFILE
          </div>
