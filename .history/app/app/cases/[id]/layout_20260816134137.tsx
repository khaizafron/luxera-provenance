    ...
    <div className="space-y-6 animate-in fade-in duration-300">
      ...
      <div className="flex items-center gap-3 text-xs text-slate-400">
        ...
        {sowCase.portfolio_client_id && (
          <>
            <span>/</span>
            <Link href={`/app/portfolio/${encodeURIComponent(sowCase.portfolio_client_id)}`} className="text-amber-300 hover:text-amber-200 font-mono">
              {sowCase.portfolio_client_name || 'Portfolio Client'}
            </Link>
          </>
        )}
      </div>
